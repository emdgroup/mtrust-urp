...
<img src="https://docs.mtrust.io/assets/images/sdk_intro-e5061a4e1b01983b800b3ce4e2c75383.png" width="300"/>
...
[![likes](https://img.shields.io/pub/likes/mtrust_urp_core)](https://pub.dev/packages/mtrust_urp_core/score)
[![popularity](https://img.shields.io/pub/popularity/mtrust_urp_core)](https://pub.dev/packages/mtrust_urp_core/score)
...
[![likes](https://img.shields.io/pub/likes/mtrust_urp_ui)](https://pub.dev/packages/mtrust_urp_ui/score)
[![popularity](https://img.shields.io/pub/popularity/mtrust_urp_ui)](https://pub.dev/packages/mtrust_urp_ui/score)
...
[![likes](https://img.shields.io/pub/likes/mtrust_urp_ble_strategy)](https://pub.dev/packages/mtrust_urp_ble_strategy/score)
[![popularity](https://img.shields.io/pub/popularity/mtrust_urp_ble_strategy)](https://pub.dev/packages/mtrust_urp_ble_strategy/score)
...
[![likes](https://img.shields.io/pub/likes/mtrust_urp_virtual_strategy)](https://pub.dev/packages/mtrust_urp_virtual_strategy/score)
[![popularity](https://img.shields.io/pub/popularity/mtrust_urp_virtual_strategy)](https://pub.dev/packages/mtrust_urp_virtual_strategy/score)
...
While we reccommend to implement your application using Flutter, the SDKs can also be used in native iOS and Android applications by following the [native embedding guides](https://docs.flutter.dev/add-to-app) provided by Flutter.
Depdending on the connection strategies you want to enable please make sure to configure the correct permissions:

| <img src="https://docs.mtrust.io/assets/images/sec_kit-6c5e19528697c126398ba0526e16784a.png" width="200">                                                                                                                                                                                                                                                | <img src="https://docs.mtrust.io/assets/images/imp_kit-9a1d7dfa9ce983c6affdc4b2c8599eef.png" width="200">                                                                                                                                                                                                                                                | <img src="https://docs.mtrust.io/assets/images/barcode_kit-f2d94203cfcde9536dddd9678f0c4f73.png" width="200">                                                                                                                                                                                                                                                                    |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| [![pub package](https://img.shields.io/pub/v/mtrust_sec_kit.svg)](https://pub.dev/packages/mtrust_sec_kit)</br>[![popularity](https://img.shields.io/pub/popularity/mtrust_sec_kit)](https://pub.dev/packages/mtrust_sec_kit/score)</br>[![pub points](https://img.shields.io/pub/points/mtrust_sec_kit)](https://pub.dev/packages/mtrust_sec_kit/score) | [![pub package](https://img.shields.io/pub/v/mtrust_imp_kit.svg)](https://pub.dev/packages/mtrust_imp_kit)</br>[![popularity](https://img.shields.io/pub/popularity/mtrust_imp_kit)](https://pub.dev/packages/mtrust_imp_kit/score)</br>[![pub points](https://img.shields.io/pub/points/mtrust_imp_kit)](https://pub.dev/packages/mtrust_imp_kit/score) | [![pub package](https://img.shields.io/pub/v/mtrust_barcode_kit.svg)](https://pub.dev/packages/mtrust_barcode_kit)</br>[![popularity](https://img.shields.io/pub/popularity/mtrust_barcode_kit)](https://pub.dev/packages/mtrust_barcode_kit/score)</br>[![pub points](https://img.shields.io/pub/points/mtrust_barcode_kit)](https://pub.dev/packages/mtrust_barcode_kit/score) |
